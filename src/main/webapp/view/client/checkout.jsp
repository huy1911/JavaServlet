                ...
                <div class="checkout-left">
                  <div class="panel-group" >
                   <c:if test="${sessionScope.username == null}">
                   		<p> You need to login to pay! Log in <a href="${pageContext.request.contextPath}/view/client/login" style="color: #754110">here!</a></p>
                   </c:if>
				 <c:if test="${sessionScope.username != null}">
                    <!-- Shipping Address -->
                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="email" placeholder="Email*"  pattern=".+@globex\.com" required="required" name="transaction_email">
                              </div>                             
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <label for="paypal"><input type="radio" id="paypal" name="transaction_payment" value="1" > Thanh toán qua ngân hàng (ATM) </label>
                   ...
                   <br>
                   		<p style="color: red">Đơn hàng của bạn đã được đặt thành công!</p>
                   </c:if>
                </div>
              </div>
            </div>
