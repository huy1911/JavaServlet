						...
						<div class="aa-product-inner">
							...
							<ul class="nav nav-tabs aa-products-tab">
								<li class="active"><a href="#raucu" data-toggle="tab">Rau
										Củ Quả</a></li>
								<li><a href="#hat" data-toggle="tab">Trái Cây</a></li>
								<li><a href="#traicay" data-toggle="tab">Các Loại Hạt </a></li>
					...
					<ul class="aa-testimonial-slider">
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/avatar_3.jpg"
									alt="avatar 1"> <span
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/hihi_4.jpg"
									alt="avatar 2"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/ui.jpg"
									alt="avatar 3"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
